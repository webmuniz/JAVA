...
public class StreamTest09 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n---------");
        IntStream.range(1, 50).filter(n -> n % 2 == 0).forEach(n -> System.out.print(n + " ")); //range - Ignore the last
        System.out.println("\n---------");

        Stream.of("THATS", "THE WAY", "IT", "IS...")
        ...
        try(Stream<String> lines = Files.lines(Paths.get("C:\\#JV\\src\\file.txt"))){
